...
standardization <- function(data, indices) {
  ...
  d1$interv <- 1
  d1$intervention_b [d1$incomecat == "30k or less"] <- -.0815979
  d1$glucose_mgdl <- NA
  ...
  d3$interv <- 3
  d3$intervention_b [d3$incomecat == "30k or less"]  <- .1140746735036373
  d3$glucose_mgdl <- NA
  
  d4 <- d # 5th copy (30th percentile): intervention set to 4, outcome to missing
  d4$interv <- 4
  d4$intervention_b [d4$incomecat == "30k or less"]  <- .133780911564827
  d4$glucose_mgdl <- NA
  
  d5 <- d # 6th copy (40th percentile): intervention set to 5, outcome to missing
  d5$interv <- 5
  d5$intervention_b [d5$incomecat == "30k or less"]  <- .146772064268589
  d5$glucose_mgdl <- NA
  
  d6 <- d # 7th copy (50th percentile): intervention set to 6, outcome to missing
  d6$interv <- 6
  d6$intervention_b [d6$incomecat == "30k or less"]  <- .1665423661470413
  d6$glucose_mgdl <- NA
  
  d7 <- d # 8th copy (60th percentile): intervention set to 7, outcome to missing
  d7$interv <- 7
  d7$intervention_b  [d7$incomecat == "30k or less"]  <- .1879632100462914
  d7$glucose_mgdl <- NA
  ...
  d9$interv <- 9
  d9$intervention_b [d9$incomecat == "30k or less"]   <- .2252189218997955
  d9$glucose_mgdl <- NA
  
  d10 <- d # 11th copy (90th percentile): intervention set to 10, outcome to missing
  d10$interv <- 10
  d10$intervention_b [d10$incomecat == "30k or less"]  <- .259517103433609
  d10$glucose_mgdl <- NA
...
standardization <- function(data, indices) {
  ...
  d1 <- d # 2nd copy (Minimum): intervention set to 1, outcome to missing
  d1$interv <- 1
  d1$intervention_b [d1$incomecat == "30k-55k"] <- -.0815979
  d1$glucose_mgdl <- NA
  ...
  d3 <- d # 4th copy (20th percentile): intervention set to 3, outcome to missing
  d3$interv <- 3
  d3$intervention_b [d3$incomecat == "30k-55k"]  <- .1140746735036373
  d3$glucose_mgdl <- NA
  
  d4 <- d # 5th copy (30th percentile): intervention set to 4, outcome to missing
  d4$interv <- 4
  d4$intervention_b [d4$incomecat == "30k-55k"]  <- .133780911564827
  d4$glucose_mgdl <- NA
  
  d5 <- d # 6th copy (40th percentile): intervention set to 5, outcome to missing
  d5$interv <- 5
  d5$intervention_b [d5$incomecat == "30k-55k"]  <- .146772064268589
  d5$glucose_mgdl <- NA
  
  d6 <- d # 7th copy (50th percentile): intervention set to 6, outcome to missing
  d6$interv <- 6
  d6$intervention_b [d6$incomecat == "30k-55k"]  <- .1665423661470413
  d6$glucose_mgdl <- NA
  
  d7 <- d # 8th copy (60th percentile): intervention set to 7, outcome to missing
  d7$interv <- 7
  d7$intervention_b  [d7$incomecat == "30k-55k"]  <- .1879632100462914
  d7$glucose_mgdl <- NA
  ...
  d9 <- d # 10th copy (80th percentile): intervention set to 9, outcome to missing
  d9$interv <- 9
  d9$intervention_b [d9$incomecat == "30k-55k"]   <- .2252189218997955
  d9$glucose_mgdl <- NA
  
  d10 <- d # 11th copy (90th percentile): intervention set to 10, outcome to missing
  d10$interv <- 10
  d10$intervention_b [d10$incomecat == "30k-55k"]  <- .259517103433609
  d10$glucose_mgdl <- NA
...
standardization <- function(data, indices) {
  ...
  d1 <- d # 2nd copy (Minimum): intervention set to 1, outcome to missing
  d1$interv <- 1
  d1$intervention_b [d1$incomecat == "55k+"] <- -.0815979
  d1$glucose_mgdl <- NA
  ...
  d3 <- d # 4th copy (20th percentile): intervention set to 3, outcome to missing
  d3$interv <- 3
  d3$intervention_b [d3$incomecat == "55k+"]  <- .1140746735036373
  d3$glucose_mgdl <- NA
  
  d4 <- d # 5th copy (30th percentile): intervention set to 4, outcome to missing
  d4$interv <- 4
  d4$intervention_b [d4$incomecat == "55k+"]  <- .133780911564827
  d4$glucose_mgdl <- NA
  
  d5 <- d # 6th copy (40th percentile): intervention set to 5, outcome to missing
  d5$interv <- 5
  d5$intervention_b [d5$incomecat == "55k+"]  <- .146772064268589
  d5$glucose_mgdl <- NA
  
  d6 <- d # 7th copy (50th percentile): intervention set to 6, outcome to missing
  d6$interv <- 6
  d6$intervention_b [d6$incomecat == "55k+"]  <- .1665423661470413
  d6$glucose_mgdl <- NA
  
  d7 <- d # 8th copy (60th percentile): intervention set to 7, outcome to missing
  d7$interv <- 7
  d7$intervention_b  [d7$incomecat == "55k+"]  <- .1879632100462914
  d7$glucose_mgdl <- NA
  ...
  d9 <- d # 10th copy (80th percentile): intervention set to 9, outcome to missing
  d9$interv <- 9
  d9$intervention_b [d9$incomecat == "55k+"]   <- .2252189218997955
  d9$glucose_mgdl <- NA
  
  d10 <- d # 11th copy (90th percentile): intervention set to 10, outcome to missing
  d10$interv <- 10
  d10$intervention_b [d10$incomecat == "55k+"]  <- .259517103433609
  d10$glucose_mgdl <- NA
